...
Edits
Author: Daniel Buchan Date: 14.10.2016
==================================================================================
...
==================================================================================
	...
	3. Type java -jar PFClust.jar <INPUT_DIR> <OUTPUT_DIR> [FILE_LIST,] (you might need to change file permissions)

		i Command Lines Options
			a) INPUT_DIR
			...
			c) data
				...
				NOTE: These files must exist in the input_dir

		ii Full Example

			java -jar PFClust.jar data/input/ data/output/ s_2.txt
